...
def sigma_drift_function(mean_props):
    # SIGMA_DRIFT = 0.004 at 0.45, 0.002 at 0.1 - reasonable inference from GRW simulations

    return 0.005714*mean_props + 0.001429 # linearly interpolates between 0.002 for prop = 0.1 and 0.004 for prop = 0.45 - to be adjusted!
...
def format_election_polls(Polling_type):
    ...
    if Polling_type == 'National':
        ...
        for election_year in ['2007','2010','2013','2016','2019','2022','2025']:
        ...
        for election_year in ['2025','prior']:
    ...
    if Polling_type == 'State Election':
        ...
        for election_year in ['1987','1990','1993','1996','1998','2001','2004']:
            ...
            # ensure only 4 parties- either DEM or GRN
